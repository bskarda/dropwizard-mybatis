 ...
 *
 * @param <T> - TypeHandler conversion type
 *
 * @see {@link URITypeHandler}, {@link UUIDTypeHandler}
 */
...
public abstract class AbstractTypeHandler<T> extends BaseTypeHandler<T> {
    ...
    @Override
    public void setNonNullParameter(PreparedStatement ps, int columnIndex, T type, JdbcType jdbcType)
            throws SQLException {
